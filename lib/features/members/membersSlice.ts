...
export const fetchMembers = createAsyncThunk("members/fetchMembers", async (_, { rejectWithValue }) => {
  try {
...
export const { setSelectedMember, setSearchTerm, setStatusFilter, clearError } = membersSlice.actions
