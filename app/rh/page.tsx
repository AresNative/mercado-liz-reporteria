...
import AreasManager from "./admin/components/areas-manager";
import PageQuizzes from "./admin/components/quizzes-manager";
import PageVideos from "./admin/components/videos-manager";
import PageEmployees from "./admin/components/employees-manager";
...
const PageAreas = () => {
    ...
    const componentes: any = {
        1: <AreasManager />, //posible eliminar este componente y dejar solo el de cuestionarios
        2: <PageEmployees />,
        3: <PageVideos />,
        4: <PageQuizzes />,
    };
                    ...
                    <div className="flex gap-2 flex-wrap mb-6">
                        {areas.map((area) => (
                            <button
                                ...
                                className={`
                                    flex items-center gap-2 px-4 py-2 rounded-lg border transition-all ${areaSeleccionada === area.id ? "bg-purple-300  border-purple-100" : "bg-gray-100 hover:bg-gray-200 border-gray-300 dark:bg-gray-700 dark:border-gray-600"}`}
                            >
                                {area.icon}
                                {area.nombre}
                            </button>
