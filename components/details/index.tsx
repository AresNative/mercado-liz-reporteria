...
export default function Details({ title, description, type, children }: DetailsProps) {
    ...
    if (type === 'form') {
        return (
            <details className="mt-4 mb-4 border border-gray-200 dark:border-zinc-700 rounded-lg overflow-auto group pb-4-">
    ...
    return (
        <details className="mb-2 mt-2 border border-gray-200 dark:border-zinc-700 rounded-lg overflow-hidden group">
