...
export function Button({
    ...
    return (
        <button
            ...
            className={cn(`flex gap-2 cursor-pointer justify-center items-center ${aling} ${sizeClass} ${styles.text} ${styles.bg} ${styles.ring} rounded-md ${styles.hover} transition-all`)}
